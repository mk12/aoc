...
NB. Assume the command-line invocation looks like this:
NB.
...
NB. Converts argument to void (no value).
void =: 0 0 $ ]
...
NB. However, some solutions need to load standard libraries (e.g. load 'regex').
NB. In those cases, we load the full system profile.
